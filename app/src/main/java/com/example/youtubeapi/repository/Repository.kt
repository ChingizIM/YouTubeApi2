...
import com.example.youtubeapi.core.network.result.RetrofitClient
...
class Repository {
    ...
    fun getPlaylists(): LiveData<Resource<Playlists>> {
        ...
        apiService.getPlaylists(Const.channelId, Const.part,
            BuildConfig.API_KEY,Const.maxResult).enqueue(object :
            Callback<Playlists> {
    ...
    fun getPlaylistItems(playlistId: String):LiveData<Resource<Item>> {
        ...
        data.value = Resource.loading(null)
        apiService.getPlaylistItems(Const.part,playlistId,
            BuildConfig.API_KEY,Const.maxResult).enqueue(object:
            Callback<Item> {
